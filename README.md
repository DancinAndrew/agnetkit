...
- `.claude/skills/` ——28 個技能（tdd-workflow、search-first、verification-loop、eval-harness、fastapi/backend/api/db 模式、mle-workflow、cost-aware-llm-pipeline、continuous-learning-v2、grill-me、quiz-me……）。
